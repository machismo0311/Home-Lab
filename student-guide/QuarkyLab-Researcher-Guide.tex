...
\begin{itemize}
  ...
  \item \code{nvidia-smi} shows GPU status and current usage. You share this \textbf{one physical GPU} with students' batch jobs and Fernanda --- glance at it before grabbing a lot of VRAM.
\end{itemize}

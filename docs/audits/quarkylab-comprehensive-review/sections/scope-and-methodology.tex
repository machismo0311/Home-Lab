...
No failure injection, no restore into production, no restarts, no configuration
changes, no credential use, and no live query of OPNsense (E-23) or the EX3400
(E-22). These boundaries are honored throughout; findings that depend on them are
marked medium-confidence and carry a precise follow-up request.
